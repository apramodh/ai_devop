...
if __name__ == "__main__":
    # Example Requirement
    requirement_text = """
    Implement a user authentication system that allows users to register, log in, and reset their passwords. The system should support email verification and multi-factor authentication.
    If the user is authenticated, they are redirected to the dashboard. 
    If unable to authenticate, mention the error.
    """
